      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            Main(내부)과 Sub(외부) 백업은{' '}
            <strong className="text-gray-900 dark:text-white">완전히 독립적</strong>으로 작동합니다.
            각각 <strong>백업 주기</strong>(예: 매일 vs 매월)와 <strong>보관 기간</strong>(자동 삭제
            주기)을 다르게 설정하여, 용량 효율과 데이터 안전성을 모두 챙길 수 있습니다.
          </p>
        </Card>
        <Card
          title="수동 관리 및 엑셀 연동"
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            설정 페이지에서 언제든{' '}
            <strong className="text-gray-900 dark:text-white">수동 백업 및 복구</strong>가
            가능합니다. 또한 <strong>엑셀 내보내기</strong>로 데이터를 활용하거나, 외부 엑셀 파일을{' '}
            <strong>가져오기(Import)</strong>하여 기존 데이터와 합칠 수도 있습니다.
          </p>
        </Card>
      </div>
      <div className="bg-gray-100 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 p-6 rounded-3xl flex items-start gap-4">
